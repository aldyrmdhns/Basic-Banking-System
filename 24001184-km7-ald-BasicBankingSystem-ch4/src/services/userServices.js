...
const createUserService = async (data) => {
    ...
    const isExist_email = await prisma.users.findUnique({where: {email: email}});
    const isExist_identity_number = await prisma.profiles.findUnique({where: {identity_number: profile.identity_number}});
